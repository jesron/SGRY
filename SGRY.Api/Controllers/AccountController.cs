...
using SGRY.Api.ViewModels.Rbac.DncMenu;
...
namespace SGRY.Api.Controllers
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(SGRYDbContext dbContext)
        {
...
WHERE P.IsDeleted=0 AND P.Status=1";
                ...
                {
                    var permissions = _dbContext.DncPermissionWithMenuMysql.FromSql(sqlPermission, user.Guid.ToString()).ToList();
