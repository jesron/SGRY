    ...
    >
      ...
      >
        ...
        <div class="logo-con">
          ...
          <span v-show="!collapsed" style="color:#fff;font-size:26px;font-weight:700;text-align:center;display:block;letter-spacing:2px;padding-top:8px;">上锅Demo</span>
