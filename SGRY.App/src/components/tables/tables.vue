<template>
  <div class="dnc-table-wrap">
    ...
    <Page  v-if="!disabledPagger"  :total="totalCount" :page-size="pageSize" size="small" show-elevator show-sizer show-total :page-size-opts="pageSizeOpts" @on-change="onPageChanged" @on-page-size-change="onPageSizeChanged">
    </Page>
